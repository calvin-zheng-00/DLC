...
for k = 1:31
    ...
    save_folder = 'C:\Users\czhe0008\Documents\EEG\old_pipe\19_08_channel\';
...
% for i = 1:length(reach_start)
%     data_points = (reach_start(i)-1499):(reach_start(i)+2000);
%     if (reach_start(i)+2000)>size(data,1)
%         continue
%     end
%     save_flag = data(data_points,:);
%     save_folder = 'C:\Users\czhe0008\Documents\EEG\old_pipe\19_08_test\';
%     if not(isfolder(save_folder))
%         mkdir(save_folder)
%     end
%     save_loc = strcat(save_folder,'trial',int2str(i),'.mat');
% 
%     save(save_loc, "save_flag")
% 
% end
