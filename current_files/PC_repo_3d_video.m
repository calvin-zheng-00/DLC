...
for a = 2:2
    ...
    for i = 1:numel(profolder)
        ...
        if a == 1
            ...
            reproarr = allproarr(:,:)*allpcarr(:,:)' + repmat(allmeanarr,height(allproarr),1);
        end
        if repo_cp ~= 0
            reproarr(1:repo_cp,:) = [];
        end
        ...
        grasp_time_3d = timeTable.grasp_time(trial)-40;
        grasp_time = timeTable.reach_time(trial)-40;
        
        figure
        hold on;
        myVideo = VideoWriter('test_video.avi');
        myVideo.FrameRate = 30;
        open(myVideo)
        axis([-700 300 -500 400 -700 100])
        xlabel('x (mm)')
        ylabel('y (mm)')
        zlabel('z (mm)')
        ...
        %     j = temp(j_temp);
            ...
            if j == 1
                ...
                set(ThumbPlotre, 'XData', [repo_e(1),repo_tcmc(1),repo_tmcp(1),repo_tip(1),repo_tt(1)], ...
                    'YData', [repo_e(2),repo_tcmc(1,2),repo_tmcp(2),repo_tip(2),repo_tt(2)], ...
                    'ZData', [repo_e(3),repo_tcmc(1,3),repo_tmcp(3),repo_tip(3),repo_tt(3)]);
                set(IndexPlotre,'XData', [repo_e(1),repo_imcp(1),repo_ipip(1),repo_idip(1),repo_it(1)], ...
                    'YData', [repo_e(2),repo_imcp(2),repo_ipip(2),repo_idip(2),repo_it(2)], ...
                    'ZData', [repo_e(3),repo_imcp(3),repo_ipip(3),repo_idip(3),repo_it(3)]);
                set(MiddlePlotre, 'XData', [repo_e(1),repo_mmcp(1),repo_mpip(1),repo_mdip(1),repo_mt(1)], ...
                    'YData', [repo_e(2),repo_mmcp(2),repo_mpip(2),repo_mdip(2),repo_mt(2)], ...
                    'ZData', [repo_e(3),repo_mmcp(3),repo_mpip(3),repo_mdip(3),repo_mt(3)]);
                set(RingPlotre, 'XData', [repo_e(1),repo_rmcp(1),repo_rpip(1),repo_rdip(1),repo_rt(1)], ...
                    'YData', [repo_e(2),repo_rmcp(2),repo_rpip(2),repo_rdip(2),repo_rt(2)], ...
                    'ZData', [repo_e(3),repo_rmcp(3),repo_rpip(3),repo_rdip(3),repo_rt(3)]);
                set(LittlePlotre, 'XData', [repo_e(1),repo_lmcp(1),repo_lpip(1),repo_ldip(1),repo_lt(1)], ...
                    'YData', [repo_e(2),repo_lmcp(2),repo_lpip(2),repo_ldip(2),repo_lt(2)], ...
                    'ZData', [repo_e(3),repo_lmcp(3),repo_lpip(3),repo_ldip(3),repo_lt(3)]);
                set(RightArmPlotre, 'XData', [repo_n(1),0,repo_s(1),repo_e(1),repo_w(1)], ...
                    'YData', [repo_n(2),0,repo_s(2),repo_e(2),repo_w(2)], ...
                    'ZData', [repo_n(3),0,repo_s(3),repo_e(3),repo_w(3)]);
