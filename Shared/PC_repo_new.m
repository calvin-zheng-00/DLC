...
for i = 1:numel(profolder)
    ...
    for j = 0:(num_pcs-1)
        ...
        if i == 1% && ismember(j,0:num_pcs-1)
            ...
            Error = table2array(compTable)-ComparisonArray;
            ...
            % ThumbPlot = plot3([compTable.TT_x(1),compTable.TIP_x(1),compTable.TMCP_x(1),compTable.TCMC_x(1),0], ...
            %     [compTable.TT_y(1),compTable.TIP_y(1),compTable.TMCP_y(1),compTable.TCMC_y(1),0], ...
            %     [compTable.TT_z(1),compTable.TIP_z(1),compTable.TMCP_z(1),compTable.TCMC_z(1),0], ...
            %     '-o', 'MarkerSize',3,'MarkerFaceColor','r', 'Color','k');
            % IndexPlot = plot3([compTable.IT_x(1),compTable.IDIP_x(1),compTable.IPIP_x(1),compTable.IMCP_x(1),0], ...
            %     [compTable.IT_y(1),compTable.IDIP_y(1),compTable.IPIP_y(1),compTable.IMCP_y(1),0], ...
            %     [compTable.IT_z(1),compTable.IDIP_z(1),compTable.IPIP_z(1),compTable.IMCP_z(1),0], ...
            %     '-o', 'MarkerSize',3,'MarkerFaceColor','m', 'Color','k');
            % MiddlePlot = plot3([compTable.MT_x(1),compTable.MDIP_x(1),compTable.MPIP_x(1),compTable.MMCP_x(1),0], ...
            %     [compTable.MT_y(1),compTable.MDIP_y(1),compTable.MPIP_y(1),compTable.MMCP_y(1),0], ...
            %     [compTable.MT_z(1),compTable.MDIP_z(1),compTable.MPIP_z(1),compTable.MMCP_z(1),0], ...
            %     '-o', 'MarkerSize',3,'MarkerFaceColor','b', 'Color','k');
            % RingPlot = plot3([compTable.RT_x(1),compTable.RDIP_x(1),compTable.RPIP_x(1),compTable.RMCP_x(1),0], ...
            %     [compTable.RT_y(1),compTable.RDIP_y(1),compTable.RPIP_y(1),compTable.RMCP_y(1),0], ...
            %     [compTable.RT_z(1),compTable.RDIP_z(1),compTable.RPIP_z(1),compTable.RMCP_z(1),0], ...
            %     '-o', 'MarkerSize',3,'MarkerFaceColor','c', 'Color','k');
            % LittlePlot = plot3([compTable.LT_x(1),compTable.LDIP_x(1),compTable.LPIP_x(1),compTable.LMCP_x(1),0], ...
            %     [compTable.LT_y(1),compTable.LDIP_y(1),compTable.LPIP_y(1),compTable.LMCP_y(1),0], ...
            %     [compTable.LT_z(1),compTable.LDIP_z(1),compTable.LPIP_z(1),compTable.LMCP_z(1),0], ...
            %     '-o', 'MarkerSize',3,'MarkerFaceColor','g', 'Color','k');
            % RightArmPlot = plot3([compTable.N_x(1),compTable.C_x(1),compTable.RS_x(1),compTable.RE_x(1),0], ...
            %      [compTable.N_y(1),compTable.C_y(1),compTable.RS_y(1),compTable.RE_y(1),0], ...
            %      [compTable.N_z(1),compTable.C_z(1),compTable.RS_z(1),compTable.RE_z(1),0], ...
            %      '-o', 'MarkerSize',3,'MarkerFaceColor',"#D95319", 'Color','k');
            % hold off;
            % xlabel('x (mm)')
            % ylabel('y (mm)')
