...
pc_src = 'C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\PCA_coeffs\';
mean_src = 'C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\PCA_mean\';
pro_src = 'C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\Projection\';
time_src = 'C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\PCA_times\';
unpro_src = 'C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\Unprojected\';
sig_src = 'C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\Significance\';
comp_src = 'C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\Comparison\';
...
allpcarr = load("C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\All\pconcat_coeff.mat");
allpcarr = allpcarr.coeff;
allproarr = load("C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\All\pconcat_project.mat");
allproarr = allproarr.score;
allmeanarr = load("C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\All\pconcat_mean.mat");
...
sig_all = matfile('C:\Users\czhe0008\Documents\MATLAB\Openpose\archive_4cats\All\pAll_sig_80.mat');
...
% opt = [1,NaN,NaN,NaN,NaN;1,2,NaN,NaN,NaN;1,3,5,NaN,NaN;1,2,3,5,NaN;1,2,3,4,5];    % 1
% opt = [1,NaN,NaN,NaN,NaN;5,21,NaN,NaN,NaN;1,2,13,NaN,NaN;4,5,6,21,NaN;1,2,4,5,13];    % 2
% opt = [3,NaN,NaN,NaN,NaN;3,23,NaN,NaN,NaN;3,23,24,NaN,NaN;3,23,24,25,NaN;3,4,23,24,25];    % 3
% opt = [1,NaN,NaN,NaN,NaN;1,3,NaN,NaN,NaN;1,3,9,NaN,NaN;1,2,3,5,NaN;1,2,3,5,9];    % 4
% opt = [1,NaN,NaN,NaN,NaN;1,3,NaN,NaN,NaN;1,3,26,NaN,NaN;1,3,4,10,NaN;1,3,4,10,26];    % 5
% opt = [18,NaN,NaN,NaN,NaN;15,18,NaN,NaN,NaN;1,4,18,NaN,NaN;1,4,15,18,NaN;1,2,4,18,26];    % 6
% opt = [1,NaN,NaN,NaN,NaN;1,25,NaN,NaN,NaN;1,2,4,NaN,NaN;1,5,9,25,NaN;1,2,3,4,5];    % 7
% opt = [1,NaN,NaN,NaN,NaN;1,2,NaN,NaN,NaN;1,2,10,NaN,NaN;1,2,6,7,NaN;1,2,3,4,10];    % 8
% opt = [1,NaN,NaN,NaN,NaN;1,3,NaN,NaN,NaN;1,3,19,NaN,NaN;1,3,4,5,NaN;1,3,4,6,19];    % 9
% opt = [5,NaN,NaN,NaN,NaN;5,9,NaN,NaN,NaN;2,5,21,NaN,NaN;2,5,6,9,NaN;2,5,18,21,26];    % 10
% opt = [1,NaN,NaN,NaN,NaN;1,4,NaN,NaN,NaN;1,5,24,NaN,NaN;1,2,3,4,NaN;1,2,4,5,24];    % 11
opt = [1,NaN,NaN,NaN,NaN;1,3,NaN,NaN,NaN;1,2,5,NaN,NaN;1,2,3,9,NaN;1,2,3,4,5];    % 12
% opt = [1,NaN,NaN,NaN,NaN;1,7,NaN,NaN,NaN;1,2,4,NaN,NaN;1,2,7,9,NaN;1,2,4,5,6];    % 13
...
for a = 2:2
    for r = 1:5
        if a == 1
            ...
            reproarr = allproarr(:,temp)*allpcarr(:,temp)' + repmat(allmeanarr,height(allproarr),1);
        else
            ...
            for j = 1:numel(subfolder)
                ...
                if (r == 5) && (j == 20)
                    ...
                    LittlePlotre = plot3([0,knuckles(5,1),PIP(4,1),DIP(4,1),Tip(4,1)], ...
                        ...
                        '-o', 'MarkerSize',3,'MarkerFaceColor',	'k', 'Color','k');
                    % RightArmPlotre = plot3([0,E(1),S(1),C(1)], ...
                    %     [0,E(2),S(2),C(2)], ...
                    %     [0,E(3),S(3),C(3)], ...
                    %     '-o', 'MarkerSize',3,'MarkerFaceColor','k', 'Color','k');
...
figure
hold on
b = bar(avgerrcomp2,'FaceColor','flat');
er2 = errorbar(avgerrcomp2,err_rangecomp2,"LineStyle","none");
% b = bar([avgerrcomp,avgerrcomp2],'FaceColor','flat');
% b(1).CData = [0 0 0];
% b(2).CData = [1 1 1];
% 
% er = errorbar([0.875,1.875,2.875,3.875,4.875],avgerrcomp,err_rangecomp,"LineStyle","none");
% er2 = errorbar([1.125,2.125,3.125,4.125,5.125],avgerrcomp2,err_rangecomp2,"LineStyle","none");
% er.Color = [1 1 1];
% er2.Color = [0.4 0.4 0.4];
% 
% xticks(1:28)
