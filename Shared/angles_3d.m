...
%src_3d = 'C:\Users\czhe0008\Documents\DLCprojects\openpose\data_conversion\massive_3d\filter_participant\p23\Instructions_BAT7\20240902T115136-115147_filtered.csv';
%src = 'C:\Users\czhe0008\Documents\DLCprojects\openpose\data_conversion\massive_3d\angles_participant_2\p23\Instructions_BAT7\20240902T115136-115147_angles.csv';
...
% testPlot1 = plot3([0,thumb_plane(1)], ...
%     [0,thumb_plane(2)], ...
%     [0,thumb_plane(3)], ...
%     '-o', 'MarkerSize',3,'MarkerFaceColor',	'b', 'Color','b');
% testPlot2 = plot3([0,thumb_rot_axis(1)/norm(thumb_rot_axis)], ...
%     [0,thumb_rot_axis(2)/norm(thumb_rot_axis)], ...
%     [0,thumb_rot_axis(3)/norm(thumb_rot_axis)], ...
%     '-o', 'MarkerSize',3,'MarkerFaceColor',	'r', 'Color','r');
% % testPlot3 = plot3([0,thumb_abd_axis(1)], ...
% %     [0,thumb_abd_axis(2)], ...
% %     [0,thumb_abd_axis(3)], ...
% %     '-o', 'MarkerSize',3,'MarkerFaceColor',	'g', 'Color','g');
% testPlot4 = plot3([0,TMCP(1)/TMCP_mag], ...
%     [0,TMCP(2)/TMCP_mag], ...
%     [0,TMCP(3)/TMCP_mag], ...
...
R = eye(3) + sin(unproTable.TCMC_rot(grasp_time)-pi/2)*K + (1-cos(unproTable.TCMC_rot(grasp_time)-pi/2))*K*K;
thumb_plane2 = (R*thumb_plane2')';
thumb_plane2 = -thumb_plane2./norm(thumb_plane2);
TMCP = TMCP + knuckles(1,:);
test2 = unproTable.TCMC_rot(grasp_time);
...
%     '-o', 'MarkerSize',3,'MarkerFaceColor',	'k', 'Color','k');
% palmPlot2 = plot3([knuckles(1,1),thumb_plane(1)*30 + knuckles(1,1)], ...
...
% alignment_transformed = original(grasp_time,:);
% figure
% hold on
...
flag = 1;
% end
test = sqrt((alignment_transformed(12)-TT(1)).^2 + (alignment_transformed(10)-TT(2)).^2 + (alignment_transformed(11)-TT(3)).^2)